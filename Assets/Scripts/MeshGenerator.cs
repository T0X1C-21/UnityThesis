...
public static class MeshGenerator
{
    ...
    {
        AnimationCurve _heightCurve = new AnimationCurve(_meshHeightCurve.keys);
        ...
        for (int y = 0; y < _height; y += _meshSimplificationIncrement)
        {
            ...
            {
                _meshData._vertices[_vertexIndex] = new Vector3(_topLeftX + x, _heightCurve.Evaluate(_heightMap[x, y]) * _heightMultiplier, _topLeftZ - y);
